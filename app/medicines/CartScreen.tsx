...
export default function CartScreen() {
  ...
  const priceCalvit = 5.8;
  const priceRelibond = 80.6;
          ...
          {qtyCalvit > 0 && (
            <View style={styles.cartItem}>
              <View style={styles.itemImageWrapper}>
                <Image
                  source={{
                    uri: "https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=150",
                  }}
          ...
          {qtyRelibond > 0 && (
            <View style={styles.cartItem}>
              <View style={styles.itemImageWrapper}>
                <Image
                  source={{
                    uri: "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?w=150",
                  }}
                  style={styles.itemImage}
                  resizeMode="contain"
                />
      ...
      <View style={styles.summaryCard}>
        ...
        <View style={styles.summaryRow}>
          ...
          <Text style={styles.summaryValue}>
            AED {subtotal > 0 ? deliveryCharge.toFixed(0) : "0"}
          </Text>
        </View>
        <View style={styles.summaryRow}>
        ...
        <TouchableOpacity
          style={[
            ...
            qtyCalvit === 0 &&
              qtyRelibond === 0 && { backgroundColor: Colors.inactive },
          ]}
